          ...
          <div className="row py-5 g-3">
            <div className="col-lg-6">
              <div className="shadow border border-0 background-color-cream rounded-3 p-3">
                ...
                <ul>
                  <li>
                    This course is targeted towards marketing professionals,
                    entrepreneurs.
                  </li>
                  <li>
                    Anyone interested in enhancing their digital marketing
            ...
            <div className="col-lg-6">
              <div className="shadow border border-0 background-color-cream rounded-3 p-3">
                ...
                <ul>
                  <li>
                    You’ll learn about various aspects of digital marketing,
                    including SEO, social media marketing, email marketing,
                    content marketing, and analytics.
                  </li>
                  <li>
                    The digital marketing landscape evolves rapidly. A course
                    can help you stay updated on the latest trends, tools, and
                    best practices.
                  </li>
                  <li>
                    Courses often provide opportunities to connect with industry
                    professionals and fellow learners, expanding your
