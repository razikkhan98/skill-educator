          ...
          <div className="row py-5 g-3">
            <div className="col-lg-6">
              <div className="shadow border border-0 background-color-cream rounded-3 p-3">
                ...
                <ul>
                  <li>
                    {" "}
                    This course is ideal for software testers, developers
                    looking to enhance their testing skills.
                  </li>
                  <li>
                    Anyone interested in pursuing a career in software quality
                    assurance.
                  </li>
            ...
            <div className="col-lg-6">
              <div className="shadow border border-0 background-color-cream rounded-3 p-3">
                ...
                <ul>
                  <li>
                    You'll learn how to create automated tests that speed up the
                    testing process, allowing teams to deliver software faster
                    and with fewer bugs
                  </li>
                  <li>
                    With automation testing skills, you can position yourself
                    for higher-level roles, such as QA lead or test architect.
                  </li>
                  <li>
                    Courses often cover various testing frameworks and tools
                    (like Selenium, JUnit, or TestNG), equipping you with a
                    diverse skill set.
                  </li>
                </ul>
              </div>
