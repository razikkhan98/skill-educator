        ...
        <div className="container">
          ...
          <div className="row py-5 g-3">
            <div className="col-lg-6">
             ...
             <ul>
              <li>This course is suitable for IT professionals, security
                enthusiasts.</li>

                <li>Anyone interested in pursuing a career in
                cybersecurity.</li>
            ...
            <div className="col-lg-6">
              <div className="shadow border border-0 background-color-cream rounded-3 p-3">
                ...
                <ul>
                  <li>
                    You’ll learn the legal and ethical aspects of hacking,
                    ensuring you understand the importance of responsible
                    behavior in cybersecurity.
                  </li>
                  <li>
                    Skills in ethical hacking can lead to various roles, such as
                    penetration tester, security analyst, or cybersecurity
                    consultant.
                  </li>
                  <li>
                    Ethical hacking involves critical thinking and creativity to
                    find solutions to complex security challenges.
                  </li>
                </ul>
              </div>
            </div>
