...
const Courses = () => {
  ...
  const handleSelect = (course) => {
    ...
    console.log("Selected Course Page:", course.page);
              ...
              >
                ...
                <div className="spacing-title text-color-light px-4">
                  ...
                  <div className="background-color-cream position-absolute bottom-0 end-0 text-color-dark d-flex flex-column justify-content-around align-items-center text-center">
                    <p className="d-flex spacing-title fs-4 mx-3 pt-1">
                      Search : ~ ${" "}
                      <Dropdown>
                        {/* <Button variant="dark" className="px-4">
                        Courses
                      <FaArrowRight className="ms-4 fs-5 animate__animated animate__fadeInLeft animate__infinite" />
                      </Button> */}
                        <Dropdown.Toggle
                          variant="dark"
                          id="dropdown-basic"
                        ...
                        >
                          Courses
                          <MdOutlineSubdirectoryArrowRight className="ms-4 fs-5 animate__animated animate__fadeInLeft animate__infinite" />
                        </Dropdown.Toggle>
                        <Dropdown.Menu>
